...
export class MyToDoListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.todoListModel = kdata.Model.define({
      fields: {
        rush: { type: "boolean" },
    ...
    this.todoListColumns = [
      ...
      },
      {
        ...
        template: function (dataItem) { if (dataItem.requestNumber) { return "<a class='gridLink' data-column='requestNumber'>" + dataItem.requestNumber + "</a>" } else { return "" } },
        filterable: {
          ui: function (element) {
      ...
      },
      {
        field: "jobNumber",
        title: "Job Number",
        template: function (dataItem) { if (dataItem.jobNumber) { return "<a class='gridLink' data-column='jobNumber'>" + dataItem.jobNumber + "</a>" } else { return "" } },
        width: 140,
      }, {
        field: "title",
        title: "Job Title",
        ...
        field: "currentTask",
        title: "Current Task",
        template: function (dataItem) { if (dataItem.currentTask) { return "<a class='gridLink' data-column='currentTask'>" + dataItem.currentTask + "</a>" } else { return "" } },
        width: 224,
      }, {
        field: "previousTask",
        title: "Previous Task",
