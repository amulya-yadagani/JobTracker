...
[dir=rtl] .k-multiselect .k-clear-value,
[dir=rtl] .k-multiselect .k-i-loading {
  right: auto;
  left: 0.75rem;
}
.k-autocomplete .k-i-loading,
...
.k-list-filter {
  ...
  position: relative;
  padding: 1rem;
  height: -webkit-calc(2.75rem + 1.5em);
...
.k-grid-header .k-header-column-menu {
  ...
  right: .5rem;
  top: 50%;
  margin-top: -webkit-calc(-0.5 * (2px + 0.75rem + 1.5em));
  margin-top: calc(-0.5 * (2px + 0.75rem + 1.5em));
  z-index: 1;
}
.k-grid-header .k-header-column-menu {
  margin: 0;
...
.k-notification .k-i-group-delete:before {
  padding: .75rem 1.25rem;
  top: 0;
  right: 0;
}
...
.k-rtl .k-menu-horizontal > .k-item + .k-item:not(.k-separator),
[dir=rtl] .k-menu-horizontal > .k-item + .k-item:not(.k-separator) {
  margin-right: 0;
  margin-left: 0;
}
...
.k-quick-replies::-webkit-scrollbar {
  display: none;
}
.k-quick-reply {
  border-radius: 100px;
...
.k-rtl .k-quick-reply + .k-quick-reply,
[dir=rtl] .k-quick-reply + .k-quick-reply {
  margin-left: 0;
  margin-right: 8px;
}
.k-chat {
