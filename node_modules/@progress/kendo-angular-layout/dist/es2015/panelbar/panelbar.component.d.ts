import { AfterViewChecked, ElementRef, EventEmitter, OnChanges, QueryList, SimpleChange, TemplateRef } from '@angular/core';
...
export declare class PanelBarComponent implements AfterViewChecked, OnChanges {
    ...
    constructor(elementRef: ElementRef, eventService: PanelBarService, rtl: boolean);
