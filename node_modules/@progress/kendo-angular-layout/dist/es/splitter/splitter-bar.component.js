...
var toggleContentOverlay = function (splitter, index, toggle) {
...
var SplitterBarComponent = /** @class */ (function () {
    function SplitterBarComponent(draggable, splitter, zone, rtl) {
    ...
    SplitterBarComponent.prototype.ngOnInit = function () {
        ...
        this.subscriptions.add(this.zone.runOutsideAngular(function () {
            var state;
            _this.draggable.kendo.press.pipe(tap(stopPropagation), filter(function () { return _this.splitter.isDraggable(_this.index); }), tap(function () { return state = _this.splitter.dragState(_this.index); }), tap(function () { return toggleContentOverlay(_this.splitter, _this.index, true); }), switchMap(preventOnDblClick(_this.draggable.kendo.release)), switchMap(createMoveStream(_this.draggable))).subscribe(function (_a) {
        ...
        this.subscriptions.add(this.draggable.kendo.release.subscribe(function () { return toggleContentOverlay(_this.splitter, _this.index, false); }));
    };
