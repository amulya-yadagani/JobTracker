...
var SplitterPaneComponent = /** @class */ (function () {
    ...
    SplitterPaneComponent.propDecorators = {
        ...
        'isHidden': [{ type: core_1.HostBinding, args: ['hidden',] },],
        'styleOrder': [{ type: core_1.HostBinding, args: ['style.order',] },],
        'styleDisplayFlex': [{ type: core_1.HostBinding, args: ['class.k-pane-flex',] },],
        'styleHeight': [{ type: core_1.HostBinding, args: ['style.flex-basis',] },],
